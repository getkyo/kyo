...
Wire shape for sealed traits is wrapper-format by default (`{"VariantName": ...}`); calling `.discriminator("type")` flips to a flat shape with a discriminator field [kyo-schema/shared/src/main/scala/kyo/Schema.scala:301-314].
