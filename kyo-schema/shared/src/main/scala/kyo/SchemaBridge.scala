...
// call them directly. These `inline` bridges live in `package kyo`, where the access succeeds, and
// the `inline s` parameter substitutes the field's concrete `summonInline[Schema[ft]]` at the call
// site.
//
