...
class ArrowEffectTest extends Test:
    ...
    "transform" - {
        "input/output" in {
            ...
            val tx = ArrowEffect.transform(Tag[TestEffect1], effect)(
                [C] => i => i + 1,
                [C] => (i, o) => o + " from " + i
            )
        ...
        "input" in {
            ...
            val tx = ArrowEffect.transformInput(Tag[TestEffect1], effect):
                [C] => i => i + 1
        ...
        "output" in {
            ...
            val tx = ArrowEffect.transformOutput(Tag[TestEffect1], effect)(
                [C] => (i, o) => o + " from " + i
            )
