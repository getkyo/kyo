...
object ArrowEffect:
    ...
    def suspend[I[_], O[_], E <: ArrowEffect[I, O], A](tag: Tag[E], input: I[A]): O[A] < E =
        Suspend[I, O, E, A, O[A], E](tag, input, o => Pure(o))
    ...
    def handle[I[_], O[_], E <: ArrowEffect[I, O], A, S](effectTag: Tag[E], v: A < (E & S))(
        ...
        Handled[I, O, E, A, A, S, A, Any](v, Handler.Cont[I, O, E, A, S](effectTag, clause), a => Pure(a))
    ...
    def handleResume[I[_], O[_], E <: ArrowEffect[I, O], A, S](effectTag: Tag[E], v: A < (E & S))(
        ...
        Handled[I, O, E, A, A, S, A, Any](v, Handler.Resume[I, O, E, A, S](effectTag, clause), a => Pure(a))
    ...
    def handleStop[I[_], O[_], E <: ArrowEffect[I, O], A, S](effectTag: Tag[E], v: A < (E & S))(
        ...
        Handled[I, O, E, A, A, S, A, Any](v, Handler.Stop[I, O, E, A, S](effectTag, clause), a => Pure(a))
    ...
    def handleFirst[I[_], O[_], E <: ArrowEffect[I, O], A, B, S](effectTag: Tag[E], v: A < (E & S))(
        ...
        Handled[I, O, E, A, B, S, B, Any](v, Handler.First[I, O, E, A, B, S](effectTag, clause, done), b => Pure(b))
    ...
    def handleLoop[I[_], O[_], E <: ArrowEffect[I, O], A, B, S, State](effectTag: Tag[E], state: State, v: A < (E & S))(
        ...
        Handled[I, O, E, A, B, S, B, Any](v, Handler.Loop[I, O, E, A, B, S, State](effectTag, state, clause, done), b => Pure(b))
