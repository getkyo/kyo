...
import kyo.kernel3.Loop.Outcome2
...
object ArrowEffect:
    ...
    inline def suspend[C, I[_], O[_], E <: ArrowEffect[I, O]](
        inline effectTag: Tag[E],
        inline v: I[C]
    )(using inline _frame: Frame): O[C] < E =
        new Kyo.Suspend[I, O, E, C, O[C], E]:
            def tag   = effectTag
            def input = v
            def frame = _frame

    inline def suspendWith[C, I[_], O[_], E <: ArrowEffect[I, O], B, S](
        inline effectTag: Tag[E],
        inline v: I[C]
    )(
        inline f: O[C] => B < S
