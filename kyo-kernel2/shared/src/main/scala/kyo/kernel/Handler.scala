...
object Handler:
    ...
    abstract class Handle[I[_], O[_], E <: ArrowEffect[I, O], A, S](tag: Tag[E]) extends Handler[I, O, E](tag):
    ...
    abstract class Partial[I[_], O[_], E <: ArrowEffect[I, O], A, S](tag: Tag[E]) extends Handler[I, O, E](tag):
