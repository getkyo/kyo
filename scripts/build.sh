...
container_provision() {
    ...
    local node_pkgs="" native_pkgs="" bssl_pkgs="" aeron_pkgs="" chrome_pkgs="" sqlite_pkgs="" doltlite_pkgs=""
...
if command -v apt-get >/dev/null 2>&1; then
    ...
    apt-get install -y -qq -o Acquire::Retries=3 $apt_pkgs $node_pkgs $native_pkgs $bssl_pkgs $aeron_pkgs $chrome_pkgs $sqlite_pkgs $doltlite_pkgs >/dev/null
