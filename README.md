...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| -------------------------- | ---------------------- | -------------- |
| [Suspension: the magic behind composability (or "The Kyo Monad")](https://www.youtube.com/watch?v=y3KiuFczOFE) <br />_&_ [_slides_](https://speakerdeck.com/fwbrasil/suspension-the-magic-behind-composability-or-the-kyo-monad) | Flavio Brasil              | Lambda Days            | June, 2025     |
