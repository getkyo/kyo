...
| [kyo-schema-json](kyo-schema-json/README.md) | ✅  | ✅  | ✅     | ✅   | JSON codec for kyo-schema: `Json.encode`/`decode`, `Json.Lines` JSONL framing, JSON Schema generation      |
| [kyo-json](kyo-json/README.md)               | ✅  | ✅  | ✅     | ✅   | Streaming JSONL/NDJSON over files and byte streams: `Jsonl.read`, `Jsonl.follow`, `Jsonl.write`            |
