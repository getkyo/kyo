...
/** Internal annotation representation.
  ...
  *
  * This is a concrete internal-package-visible definition of the same structure declared at the public level in `Reflect.Annotation`. The
  * internal version is used during pass 1 to record raw annotation slices before the type is resolved.
  */
final case class Annotation(annotationType: Reflect.Type, argsPickle: Chunk[Byte])
