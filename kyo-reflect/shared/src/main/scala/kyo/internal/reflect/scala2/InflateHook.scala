...
/** Platform-specific ZLIB inflation hook for Scala 2 "Scala" attribute decoding.
  *
  * On JVM, delegates to java.util.zip.InflaterInputStream. On JS and Native, fails with ReflectError.NotImplemented because ZLIB inflation
  * is not available without JVM or a bundled C library.
  *
...
abstract private[scala2] class InflateHookImpl:
    /** Decompress ZLIB-compressed bytes.
      *
      * Returns the decompressed bytes, or Abort.fail(ReflectError.NotImplemented) on JS/Native.
      */
