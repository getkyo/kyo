...
/** Container-gated integration tests for the PostgreSQL transaction surface: isolation levels, READ ONLY transactions, and savepoints
  * through nested transactions.
  *
  ...
  * source of truth.
  */
class PostgresTransactionIntegrationTest extends SqlContainerTest:
    ...
    // ── savepoints / nested transactions (PG) ─────────────────────────────────
