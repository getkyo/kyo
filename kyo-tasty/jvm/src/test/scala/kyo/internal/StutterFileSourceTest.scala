...
/** Tests for StutterFileSource primitive (Phase 2.09: F-A4-OPEN-RW prerequisite).
  *
...
class StutterFileSourceTest extends Test:
    ...
    // Pins: STUTTER primitive correctness
    "Phase 2.09 leaf 18: StutterFileSource.wrapping blocks read until semaphore is released" in run {
