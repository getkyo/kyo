...
/** Canonical factory that converts a fully-populated SymbolDescriptor into the matching typed Symbol subtype.
  ...
  * Maybe.Present(buffer) means record errors into buffer; under FailFast throw SymbolMaterializationError instead.
  */
    ...
    def from(
        ...
        d.kind match
            ...
            case SymbolKind.EnumCase =>
                ...
                // Symbol.Class is the open base; Symbol.EnumCase extends it so callers matching
                // Symbol.Class still work, but callers can discriminate via Symbol.EnumCase.
