...
class JavaMetadataPredicateTest extends kyo.test.Test[Any]:
    ...
    "Leaf 170: isJvmPublic and isJvmStatic true for 0x0009; isJvmFinal false" in {
    ...
    "Leaf 171: isJvmPrivate true for 0x0002; others false" in {
        val m = meta(0x0002)
    ...
    "Leaf 171b: isJvmFinal true for 0x0010; others false" in {
        val m = meta(0x0010)
    ...
    "Leaf 171c: isJvmProtected true for 0x0004" in {
        val m = meta(0x0004)
