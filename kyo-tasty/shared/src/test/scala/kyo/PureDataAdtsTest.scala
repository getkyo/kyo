...
class PureDataAdtsTest extends Test:
    ...
    val _s16: Schema[Tasty.Symbol.Unresolved]   = summon[Schema[Tasty.Symbol.Unresolved]]
    ...
    val _s28: Schema[Tasty.JavaAnnotation]      = summon[Schema[Tasty.JavaAnnotation]]
    val _s29: Schema[Tasty.JavaMetadata]        = summon[Schema[Tasty.JavaMetadata]]
    val _s30: Schema[Tasty.ModuleDescriptor]    = summon[Schema[Tasty.ModuleDescriptor]]
    ...
    val _c17: CanEqual[Tasty.JavaAnnotation, Tasty.JavaAnnotation]   = summon[CanEqual[Tasty.JavaAnnotation, Tasty.JavaAnnotation]]
    val _c18: CanEqual[Tasty.JavaMetadata, Tasty.JavaMetadata]       = summon[CanEqual[Tasty.JavaMetadata, Tasty.JavaMetadata]]
