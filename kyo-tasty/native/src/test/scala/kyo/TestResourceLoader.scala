...
/** Native implementation: serves `.tasty` and `.class` fixture bytes from `kyo.fixtures.Embedded`
  * (an sbt-generated table in the kyo-tasty/fixtures sub-project). Documentation files and source
...
object TestResourceLoader:
    ...
    def loadBytes(resourcePath: String): Array[Byte] =
        resourcePath match
            ...
            case other =>
                throw new RuntimeException(s"Native: fixture not embedded: $other; add to Embedded.scala under kyo-tasty/fixtures")
