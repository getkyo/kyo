...
/** Native stub for the cross-platform TestClasspaths2 facade. Every method throws UnsupportedOperationException; JVM-only operations are
  * guarded by the `jvmOnly` tag at call sites.
  */
