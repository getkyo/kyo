...
lazy val `kyo-tapir` =
    crossProject(JVMPlatform)
        ...
        .settings(
            `kyo-settings`,
            libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-core"         % "1.10.4",
            libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-netty-server" % "1.10.4"
        )
...
lazy val `kyo-examples` =
    crossProject(JVMPlatform)
        ...
        .settings(
            ...
            libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.10.4"
        )
