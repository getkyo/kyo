...
lazy val `kyo-net` =
    crossProject(JSPlatform, JVMPlatform, NativePlatform, WasmPlatform)
        ...
        .settings(
            ...
            // the opposite case, a shim whose library a Native binary has no other way to get. Both are delivered to
            // Node, where koffi opens a file by path and the classpath is invisible.
