...
class CodeGeneratorTest extends AnyFreeSpec {
    ...
    "CodeGenerator" - {
        "process a request with default options" in {
            ...
            java.nio.file.Files.writeString(java.nio.file.Path.of("/tmp/gen-multi-1.txt"), file1.getContent)
            ...
            java.nio.file.Files.writeString(java.nio.file.Path.of("/tmp/gen-multi-2.txt"), file2.getContent)
        ...
        "process a request with single file" in {
            ...
            java.nio.file.Files.writeString(java.nio.file.Path.of("/tmp/gen-single.txt"), file.getContent)
