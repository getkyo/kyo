...
KYO_IT_API double kyo_it_circle_area(const kyo_it_circle_t *c) {
 ...
 * outer struct levels. */
KYO_IT_API double kyo_it_circle_sum(const kyo_it_circle_t *c, double dx, double dy) {
...
KYO_IT_API int32_t kyo_it_packed_value(const kyo_it_packed_t *p) {
...
KYO_IT_API int32_t kyo_it_make_pair(int32_t a, int32_t b, int32_t *out_b) {
    *out_b = a * b;
    return a + b;
}
...
KYO_IT_API void kyo_it_make_circle(kyo_it_circle_t *out, double cx, double cy, double r) {
    out->center.x = cx;
    out->center.y = cy;
    out->radius   = r;
}
...
KYO_IT_API void kyo_it_make_box(kyo_it_box_t *out, int32_t v) {
    out->v = v;
}
...
KYO_IT_API void kyo_it_make_circle_blocking(kyo_it_circle_t *out, double cx, double cy, double r) {
    out->center.x = cx;
    out->center.y = cy;
    out->radius   = r;
}
