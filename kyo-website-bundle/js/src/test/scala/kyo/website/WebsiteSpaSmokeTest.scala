...
class WebsiteSpaSmokeTest extends kyo.test.Test[Any]:
    ...
    // In-Chrome chrome parity. Cross-platform gate; needs the served-bundle Chrome harness.
    "post-mount chrome DOM equals the SSG chrome (cross-platform gate)".ignore in {
