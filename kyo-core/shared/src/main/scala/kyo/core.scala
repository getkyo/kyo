...
object core {
  ...
  private[kyo] abstract class KyoRoot[M[_], E <: Effect[M], T, S](v: M[T], e: E)
  ...
  extension [M[_], T, S](v: M[T] > S) {
    @targetName("suspend")
    /*inline(3)*/
    def >[E <: Effect[M]]( /*inline(3)*/ e: E): T > (S & E) =
  ...
  private[kyo] def transform[T, S, U, S2](v: T > S)(f: T => U > S2): U > (S & S2) =
    v(f)
  ...
  extension [T, S](v: T > S) {
    ...
    /*inline(3)*/
    private[kyo] def apply[U, S2]( /*inline(3)*/ f: T => (U > S2)): U > (S & S2) =
