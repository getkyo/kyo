...
extension (value: 1)
    ...
    inline def nanos: Duration   = compiletime.error("please use `.nano`")
    inline def micros: Duration  = compiletime.error("please use `.micro`")
    inline def millis: Duration  = compiletime.error("please use `.milli`")
    inline def seconds: Duration = compiletime.error("please use `.second`")
    inline def minutes: Duration = compiletime.error("please use `.minute`")
    inline def hours: Duration   = compiletime.error("please use `.hour`")
    inline def days: Duration    = compiletime.error("please use `.day`")
    inline def weeks: Duration   = compiletime.error("please use `.week`")
    inline def months: Duration  = compiletime.error("please use `.month`")
    inline def years: Duration   = compiletime.error("please use `.year`")
end extension
