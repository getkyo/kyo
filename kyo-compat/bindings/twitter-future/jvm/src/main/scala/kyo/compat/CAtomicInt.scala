...
/** Underlying carrier is `java.util.concurrent.atomic.AtomicInteger`, a lock-free atomic int cell. There is no `Frame` / `Trace` to
  ...
  * contract: reads, writes, compare-and-swap, and numeric increments all execute without holding a lock.
  */
