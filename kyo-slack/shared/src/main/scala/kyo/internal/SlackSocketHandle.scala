...
/** Internal carrier behind the opaque `kyo.Slack` connection type. Holds the live
  * engine and config for the manual receive/close path. The controller slot is
  * populated by the reconnect layer.
  */
