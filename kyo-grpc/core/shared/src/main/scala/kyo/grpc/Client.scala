...
/** Utilities for creating and managing gRPC client channels.
  ...
  *
  * Key features:
  *   - Automatic resource cleanup via [[Scope]] effect
...
object Client:
    ...
    /** Creates a managed gRPC channel with automatic resource cleanup.
      *
      * Creates a [[ManagedChannel]] that is automatically acquired and released via the [[Scope]] effect. The channel is configured using
      * the provided `configure` function and will be properly shut down when the resource is released.
      *
