...
object Client:
    ...
    /** Creates a managed gRPC channel with automatic resource cleanup.
      ...
      * to create typed gRPC clients.
      *
      * @example
      *   {{{
      *   // Create a simple insecure channel
      *   val simpleChannel = Client.channel("localhost", 8080)(_.usePlaintext())
      *   
      ...
      *   )
      *   
      *   // Use with generated service client (assuming a GreeterService exists)
      *   for
