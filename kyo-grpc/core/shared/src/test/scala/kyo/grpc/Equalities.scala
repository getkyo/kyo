...
object Equalities:
    ...
    given tuple2Equality: [A: {Equality as eqA, ClassTag}, B: {Equality as eqB, ClassTag}] => Equality[(A, B)]:
        def areEqual(a: (A, B), b: Any): Boolean =
            b match
                case (b1: A, b2: B) => eqA.areEqual(a._1, b1) && eqB.areEqual(a._2, b2)
                case _              => false
        end areEqual
    end tuple2Equality
