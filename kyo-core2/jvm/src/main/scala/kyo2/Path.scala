...
//       */
//     def readStream(charset: Charset = java.nio.charset.StandardCharsets.UTF_8)(using Frame): Stream[String, Async & IO] < Resource =
...
//       */
//     def readLinesStream(charset: Charset = java.nio.charset.StandardCharsets.UTF_8)(using Frame): Stream[String, Async & IO] < Resource =
...
//       */
//     def readBytesStream(using Frame): Stream[Byte, Async & IO] < Resource =
