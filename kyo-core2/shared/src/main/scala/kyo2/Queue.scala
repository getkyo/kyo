...
class Queue[T] private[kyo2] (initFrame: Frame, private[kyo2] val unsafe: Queue.Unsafe[T]):
...
object Queue:
    ...
    class Unbounded[T] private[kyo2] (initFrame: Frame, unsafe: Queue.Unsafe[T]) extends Queue[T](initFrame, unsafe):
