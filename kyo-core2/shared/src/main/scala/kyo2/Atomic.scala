...
class AtomicInt private[kyo2] (ref: j.AtomicInteger) extends AnyVal:
...
class AtomicLong private[kyo2] (ref: j.AtomicLong) extends AnyVal:
...
class AtomicBoolean private[kyo2] (ref: j.AtomicBoolean) extends AnyVal:
...
class AtomicRef[T] private[kyo2] (private val ref: j.AtomicReference[T]) extends AnyVal:
