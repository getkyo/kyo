...
abstract class Test extends AsyncFreeSpec with BaseKyoTest[Abort[Any] & Async] with NonImplicitAssertions:
    ...
    def run(v: Future[Assertion] < (Abort[Any] & Async)): Future[Assertion] =
