...
hierarchy; the campaign added ZERO new top-level types. The surface groups into four
jobs plus controls.
...
visual-QA campaign deliberately promoted them (they settle after via
...
1. In `CdpTypes.scala`, add a `final private[kyo] case class ...Params(...) derives
   ...
   campaign added several here: `SetEmulatedMediaParams`, `StartScreencastParams`,
