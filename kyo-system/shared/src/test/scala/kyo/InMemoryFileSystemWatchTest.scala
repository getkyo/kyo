...
class InMemoryFileSystemWatchTest extends FileSystemWatchTestSuite:

    // Mutation completion publishes events without a polling timer.
...
end InMemoryFileSystemWatchTest
