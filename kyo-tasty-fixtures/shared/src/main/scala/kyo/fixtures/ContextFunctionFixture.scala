...
/** Context-function fixtures for cross-platform testing of Type.ContextFunction decoding.
  ...
  * CONTEXTFUNCTIONtype. Without this fixture the embedded set contains no context function types and ContextFunctionFidelity2Test leaves 1-4
  * would fail on JS/Native with a count of zero.
  *
  * Design:
