...
object MysqlPacket:
    ...
    def writeOne(payload: Span[Byte], seq: Int): Chunk[Span[Byte]] =
        ...
        if total < MaxPayload then
            ...
            // Performance: while loop for the split-packet framing; its mutable state does not escape this method.
    ...
    def readOne(buf: AccumulatedBuffer): Maybe[(Span[Byte], Int)] =
        ...
        // Performance: while loop for the packet reassembly; its mutable state does not escape this method.
        while !done do
