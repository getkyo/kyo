...
class JsonRpcEnvelopeIdTest extends JsonRpcTest:
    ...
    "Num case round-trips through Structure" in {
    ...
    "Str case round-trips through Structure" in {
    ...
    "encoding Num produces a numeric Structure value" in {
    ...
    "encoding Str produces a string Structure value" in {
    ...
    "decoding Structure.Value.Null fails" in {
