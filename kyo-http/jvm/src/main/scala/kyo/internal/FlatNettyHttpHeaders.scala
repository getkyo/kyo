...
/** Lightweight Netty HttpHeaders backed by a flat interleaved String array.
  ...
  * pool.
  */
final private[kyo] class FlatNettyHttpHeaders private[internal] (private var arr: Array[String]) extends NettyHttpHeaders:
...
object FlatNettyHttpHeaders:
    ...
    private[kyo] def acquire(): FlatNettyHttpHeaders =
    ...
    private[kyo] def releaseInstance(h: FlatNettyHttpHeaders): Unit =
