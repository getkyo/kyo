...
object GenIntegralPoly:
    ...
    /** Constructs an instance of `GenIntegralPoly` using the specified `Gen` and `Integral` instances, existentially hiding the underlying
      * type.
      */
