...
object Annotations:
    ...
    /** Accesses an `Annotations` instance in the environment and retrieves the annotation of the specified type, or its default value if
      * there is none.
      */
    def get[V](key: TestAnnotation[V])(implicit trace: Trace): UIO[V] =
    ...
    /** Accesses an `Annotations` instance in the environment and executes the specified effect with an empty annotation map, returning the
      * annotation map along with the result of execution.
      */
    def withAnnotation[R, E](zio: ZIO[R, TestFailure[E], TestSuccess])(implicit
        trace: Trace
    ): ZIO[R, TestFailure[E], TestSuccess] =
