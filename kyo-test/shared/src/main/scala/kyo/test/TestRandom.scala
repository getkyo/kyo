...
trait TestRandom extends Random with Restorable:
    def clearBooleans(implicit trace: Frame): Unit < IO
    def clearBytes(implicit trace: Frame): Unit < IO
    def clearChars(implicit trace: Frame): Unit < IO
    def clearDoubles(implicit trace: Frame): Unit < IO
    def clearFloats(implicit trace: Frame): Unit < IO
    def clearInts(implicit trace: Frame): Unit < IO
    def clearLongs(implicit trace: Frame): Unit < IO
    def clearStrings(implicit trace: Frame): Unit < IO
    def clearUUIDs(implicit trace: Frame): Unit < IO
    def feedBooleans(booleans: Boolean*)(implicit trace: Frame): Unit < IO
    def feedBytes(bytes: Chunk[Byte]*)(implicit trace: Frame): Unit < IO
    def feedChars(chars: Char*)(implicit trace: Frame): Unit < IO
    def feedDoubles(doubles: Double*)(implicit trace: Frame): Unit < IO
    def feedFloats(floats: Float*)(implicit trace: Frame): Unit < IO
    def feedInts(ints: Int*)(implicit trace: Frame): Unit < IO
    def feedLongs(longs: Long*)(implicit trace: Frame): Unit < IO
    def feedStrings(strings: String*)(implicit trace: Frame): Unit < IO
    def feedUUIDs(uuids: UUID*)(implicit trace: Frame): Unit < IO
    def getSeed(implicit trace: Frame): Long < IO
    def setSeed(seed: => Long)(implicit trace: Frame): Unit < IO
    def nextBoolean(implicit trace: Frame): Boolean < IO
    def nextBytes(length: => Int)(implicit trace: Frame): Chunk[Byte] < IO
    def nextDouble(implicit trace: Frame): Double < IO
    def nextDoubleBetween(minInclusive: => Double, maxExclusive: => Double)(implicit trace: Frame): Double < IO
    def nextFloat(implicit trace: Frame): Float < IO
    def nextFloatBetween(minInclusive: => Float, maxExclusive: => Float)(implicit trace: Frame): Float < IO
    def nextGaussian(implicit trace: Frame): Double < IO
    def nextInt(implicit trace: Frame): Int < IO
    def nextIntBetween(minInclusive: => Int, maxExclusive: => Int)(implicit trace: Frame): Int < IO
    def nextIntBounded(n: => Int)(implicit trace: Frame): Int < IO
    def nextLong(implicit trace: Frame): Long < IO
    def nextLongBetween(minInclusive: => Long, maxExclusive: => Long)(implicit trace: Frame): Long < IO
    def nextLongBounded(n: => Long)(implicit trace: Frame): Long < IO
    def nextPrintableChar(implicit trace: Frame): Char < IO
end TestRandom
