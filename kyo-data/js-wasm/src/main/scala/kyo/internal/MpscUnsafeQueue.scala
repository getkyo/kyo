...
/** Bounded MPSC queue — JS single-threaded simplification of JCTools MpscAtomicArrayQueue.
  *
  * Uses a plain ring buffer with head/tail indices. No CAS needed on JS. Minimum capacity is 2 (matches JVM/Native).
  */
